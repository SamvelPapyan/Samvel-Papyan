...
function printStat() {
	var file = "stat.json";
	jsonObj.info.push({"Grass":xotQanakStat, "Xotaker":xotakerQanakStat, "Gishatich":gishQanakStat, "Bomb":bombQanakStat, "Vorsord":vorsQanakStat});
	var stat = JSON.stringify(jsonObj);
	var fullStat = stat + "\n";
	fs.writeFileSync(file, fullStat);
